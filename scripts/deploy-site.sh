...
echo "6) Data wilayah (provinsi/kabupaten/kecamatan/desa) SUDAH ada dari dump database di atas."
echo "   Yang ini cuma tes SEKALI di VPS baru: pastikan Puppeteer/Chrome headless jalan normal"
echo "   buat fitur statistik live per-provinsi (otomatis jalan tiap admin ganti provinsi di panel):"
echo "   node scripts/sync-simkopdes.mjs --region=31   (ganti 31 dengan kode provinsi situs ini)"
