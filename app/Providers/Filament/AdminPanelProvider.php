...
class AdminPanelProvider extends PanelProvider
{
    ...
    {
        return $panel->default()->id('kopdes')->path('admin')->login()->profile(isSimple: false)
            ->brandName('Admin Kopdes')->favicon(asset('favicon.svg'))->colors(['primary' => Color::hex('#065366')])->darkMode(false)
